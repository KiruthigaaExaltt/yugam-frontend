            ...
            <div className="flex flex-col gap-8 my-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {[
                        ...
                        <div key={i} className="flex items-center justify-between p-4 bg-white rounded-xl border border-[var(--surface-border)] shadow-sm">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 bg-white p-8 rounded-2xl border border-[var(--surface-border)] shadow-sm">
                    {[
